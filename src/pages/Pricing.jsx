      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <h2 className="text-2xl font-bold text-darkNavy mb-3">
              Free
            </h2>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl border-2 border-primaryBlue p-8">
            ...
            <h2 className="text-2xl font-bold text-primaryBlue mb-3">
              Pro
            </h2>
        ...
        <div className="mt-16">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <p className="text-gray-600 mt-2">
                Stripe integration will securely process all payments once
