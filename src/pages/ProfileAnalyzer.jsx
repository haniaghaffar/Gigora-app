    ...
    <div className="min-h-screen bg-gray-100 py-10 px-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <p className="mt-3 text-gray-600">
          Describe your skills, experience, and services to get AI-powered suggestions.
        </p>

        <textarea
          value={profile}
          onChange={(e) => setProfile(e.target.value)}
          placeholder="Describe your skills, experience, and services here..."
          className="w-full mt-6 p-4 border rounded-lg h-40 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        {profile.trim() === "" && (
          <p className="text-red-500 mt-1 text-sm">Profile description cannot be empty.</p>
        )}
        ...
        {!loading && result && (
          <div className="grid md:grid-cols-2 gap-6 mt-10">
            <Card>
              ...
              <p className="text-3xl font-bold mt-3">{result.score}</p>
            </Card>

            <Card>
              <h2 className="text-xl font-bold text-gray-800">✅ What is Good</h2>
            ...
            <Card>
              <h2 className="text-xl font-bold text-gray-800">❌ What to Improve</h2>
              <ul className="list-disc ml-5 mt-3 space-y-2">
