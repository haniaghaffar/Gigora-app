...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-darkNavy border-b border-gray-200">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          {user ? (
            <>
              <Link
                to="/dashboard"
                className="px-5 py-2 rounded-full bg-blue-50 text-primaryBlue font-semibold hover:bg-primaryBlue hover:text-white transition"
              >
                Dashboard
              </Link>
              ...
              <button
                ...
                className="px-5 py-2 border border-red-500 text-red-500 rounded-full hover:bg-red-500 hover:text-white transition"
              >
                Logout
              </button>
            </>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t px-6 py-6 space-y-5">
          <button onClick={() => scrollToSection("features")} className="block text-gray-700 font-medium">
            Features
          </button>
          <button onClick={() => scrollToSection("pricing")} className="block text-gray-700 font-medium">
            Pricing
          </button>
          {user ? (
            <>
