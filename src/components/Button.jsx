...
export default function Button({
  ...
  // Base button styles
  const baseClasses = "inline-flex items-center justify-center min-h-12 min-w-12 px-5 rounded-lg font-medium text-sm transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primaryBlue";;
